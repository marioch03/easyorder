...
CREATE INDEX idx_mesa_tenant ON Mesa (id_tenant);
...
CREATE INDEX idx_zona_tenant ON Zona (id_tenant);
...
CREATE INDEX idx_pedido_tenant ON Pedido (id_tenant);
...
CREATE INDEX idx_producto_tenant ON Producto (id_tenant);
...
CREATE INDEX idx_productotipo_tenant ON ProductoTipo (id_tenant);
...
CREATE INDEX idx_sesion_tenant ON Sesion (id_tenant);
